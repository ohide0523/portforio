...
const Login = () => {
  ...
  const anonymouslyLogin = () => {
    auth
      ...
      .then((res) => {
        alert("ログインしました！")
        router.push("/Top"); const firstLogin = res.additionalUserInfo.isNewUser;
        // 初めてなら、アカウントの作成を行う
        if (firstLogin) {
...
<TextField
        ...
        />
              ...
              >
                ...
                <Button variant="contained"　onClick={anonymouslyLogin} style={{marginTop:"30px"}}>テストユーザーログイン</Button>
              </div>
            </div>
          </main>
        </>
