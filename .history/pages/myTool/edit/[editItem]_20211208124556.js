...
import { MuiThemeProvider, createMuiTheme } from '@material-ui/core/styles/MuiThemeP';
  ...
  return (
    <MuiThemeProvider theme={theme}>
      ...
      >
        ...
        <Link href="/Top">
        <Button variant="contained" 　onClick={onClickUpdate_item} sx={{width:"100%",marginTop:"50px",}}>削除</Button>
