  ...
  return (
    <>
      ...
      <div className={Styles.input_form}>
        ...
        /> */}
         <TextField id="filled-basic"  variant="filled" value={content} onChange={(e) => setContent(e.target.value)} ref={ref} sx={{width:"100%"}}　onKeyDown={(e) => submitMsg(e)}
          />
         <Button variant="contained" endIcon={<SendIcon />} onClick={onClickSubmitMsg} sx={{textAlign:"center"}}>
