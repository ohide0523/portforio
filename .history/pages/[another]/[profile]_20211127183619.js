      ...
      {anotherUser.length > 0 &&
        anotherUser.map((user, index) => (
          ...
          >
            ...
            <div style={{ display: "flex", alignItems: "center",padding:"20px",flexDirection:"column"}}>
              {follow ? (
                <Button
                  variant="outlined"
              ...
              >
                <Button variant="contained" sx={{width:"200px",marginTop:"10px"}}>この人とチャットする</Button>
              </Link>
            </div>
          </div>
        ))}
