      ...
      {anotherItem.length > 0 &&
        anotherItem.map((item, index) => (
          <div key={index}>
            ...
            <div style={{display:"flex",flexDirection:"column",justifyContent:"space-around",width:"300px"}}>
               <div style={{ display: "flex", alignItems: "center",justifyContent:"space-betwee" }}>
              <h3>カテゴリー</h3>
              <p>{item.category[0]}/{item.category[1]}</p>
            </div>
