...
const item = () => {
  ...
  return (
    <div style={{width:"80%",display:"flex",flexDirection:"column",alignItems:"center",textAlign:"center"}}>
      <div
        style={{
          display: "flex",
      ...
      >
        {anotherItem.length > 0 &&
          anotherItem.map((item, index) => (
            <div key={index}>
              <div style={{ display: "flex", alignItems: "center",justifyContent:"center",padding:"30px",width:"80%"}}>
                <h1>ワンちゃんの紹介ページ</h1>
                {item.userId == uid && (
                  <Link
              ...
              <div key={index} style={{ marginBottom: "100px" }}>
                ...
                >
                  ...
                  <div style={{ display: "flex", flexDirection: "column" }}>
                    ...
                    <div>{user.follower}<span style={{fontSize:"12px"}}>フォロワー</span></div>
                  </div>
                </div>
