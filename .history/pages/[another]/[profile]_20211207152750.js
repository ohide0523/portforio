    ...
    <div>
      {anotherUser.length > 0 &&
        anotherUser.map((user, index) => (
          <div key={index}>
            <div
              className={Styles.another_profile_top_container}
              
            >
              <Avatar
                alt="アバター画像"
                src={user.img}
                className={Styles.another_user_icon}
              />
              ...
              <div style={{display:"flex",alignItems:"center"}}>
                ...
                <div>
                   <div
                className={Styles.another_profile_title}
              >
                ...
                <div
                  className={Styles.another_user_icon_button}
                >
                  {follow ? (
                    <Button
                      variant="outlined"
            ...
            <div style={{textAlign:"center",marginTop:"50px",width:"80%",margin:"auto"}}> 
