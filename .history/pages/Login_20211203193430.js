    ...
    <>
      {isSearch ? (
        ...
        <>
          ...
          <main style={{width:"70%",margin:"auto",marginTop:"100px",display:"flex",flexDirection:"column",alignItems:"center"}}>
            <h1>ログインページ</h1>
            <div style={{textAlign:"center"}}>
              ...
              <h3>または</h3>
              <div style={{display:"flex",flexDirection:"column",marginBotto}}>
                 <h2>新規会員登録</h2>
