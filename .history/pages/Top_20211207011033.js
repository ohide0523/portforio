...
const useStyles = makeStyles((theme) => ({
  root: {
   width:"90%", height:400,margin:"auto"
   [theme.breakpoints.up("md")]:var unwatch = this.$watch('propertyName', function (newValue, oldValue) {
          ...
          <main className={Styles.main_top}>
            ...
            <div className={Styles.itemTitle}>
              ...
              <hr />
                ...
                <ImageList
                 cols={3}
                  // className={Styles.item_img_list}
